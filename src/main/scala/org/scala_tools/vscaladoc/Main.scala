...
import org.scala_tools.compiler.reporters.MyConsoleReporter
//import org.scala_tools.vscaladoc.DocDriver

/**
 * Customized copy of scala.tools.nsc.Main
 */
object Main extends AnyRef with EvalLoop {
  ...
  def process(args: Array[String]) {
    ...
    reporter = new MyConsoleReporter(settings)
